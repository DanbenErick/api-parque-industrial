...
export class UsuarioController {
  ...
  public resetPassword = async (req: Request<{ id: string }>, res: Response): Promise<any> => {
    ...
    try {
      ...
      await this.usuarioRepo.updatePassword(id, hashedPassword);
      
      res.json({ message: 'Contraseña restablecida', newPassword });
    } catch (error) {
