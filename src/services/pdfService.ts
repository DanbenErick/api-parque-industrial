...
// -------------------------------------------------------
export const buildReciboPdf = async (req: Request<{ id: string }>, res: Response): Promise<any> => {
...
export const buildReciboPdfV2 = async (req: Request<{ id: string }>, res: Response): Promise<any> => {
  const id = Number(req.params.id);
...
export const buildReciboPdfV3 = async (req: Request<{ id: string }>, res: Response): Promise<any> => {
  const id = Number(req.params.id);
...
// -------------------------------------------------------
export const buildAllRecibosPdfV2 = async (req: Request<{}, any, any, IGetRecibosQuery>, res: Response): Promise<any> => {
  try {
    const filters = {
      year: req.query.year,
