...
export class ConfigRepository {
    ...
    public updateConfig = async (monto_multa_base: number, monto_instalacion_base: number): Promise<void> => {
          await this.db.query('UPDATE configuracion SET monto_multa_base = ?, monto_instalacion_base = ? WHERE id = 1', [
