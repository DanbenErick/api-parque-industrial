...
export class PeriodoRepository {
    ...
    public create = async (periodo: any): Promise<number> => {
          const { mes_anio, factor_multiplicador, tarifa_kwh, tarifa_kwh_tr, tarifa_kwh_punta, costo_potencia, costo_potencia_fuera_punta, precio_energia_reactiva, tarifa_mantenimiento_normal, tarifa_mantenimiento_tiempo_real, fecha_inicio, fecha_fin, fecha_emision_recibo, fecha_vencimiento, fecha_corte, fecha_inicio_lectura, fecha_fin_lectura, created_by } = periodo;
          const [result]: any = await this.db.query(
            `INSERT INTO periodo_facturacion (
      mes_anio, factor_multiplicador, tarifa_kwh, tarifa_kwh_tr, tarifa_kwh_punta, costo_potencia, costo_potencia_fuera_punta, precio_energia_reactiva, tarifa_mantenimiento_normal, tarifa_mantenimiento_tiempo_real, fecha_inicio, fecha_fin, fecha_emision_recibo, fecha_vencimiento, fecha_corte, fecha_inicio_lectura, fecha_fin_lectura, created_by
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [mes_anio, factor_multiplicador || 1.0000, tarifa_kwh, tarifa_kwh_tr || 0, tarifa_kwh_punta || 0, costo_potencia || 0, costo_potencia_fuera_punta || 0, precio_energia_reactiva || 0, tarifa_mantenimiento_normal, tarifa_mantenimiento_tiempo_real, fecha_inicio, fecha_fin, fecha_emision_recibo, fecha_vencimiento, fecha_corte, fecha_inicio_lectura, fecha_fin_lectura, created_by]
          );
    ...
    public update = async (id: number, periodo: any): Promise<number> => {
     ...
     SET mes_anio = ?, factor_multiplicador = ?, tarifa_kwh = ?, tarifa_kwh_tr = ?, tarifa_kwh_punta = ?, costo_potencia = ?, costo_potencia_fuera_punta = ?, precio_energia_reactiva = ?,
     ...
     WHERE id = ? AND deleted_at IS NULL`,
            [mes_anio, factor_multiplicador, tarifa_kwh, tarifa_kwh_tr || 0, tarifa_kwh_punta || 0, costo_potencia || 0, costo_potencia_fuera_punta || 0, precio_energia_reactiva || 0, tarifa_mantenimiento_normal, tarifa_mantenimiento_tiempo_real, fecha_inicio, fecha_fin, fecha_emision_recibo, fecha_vencimiento, fecha_corte, fecha_inicio_lectura, fecha_fin_lectura, id]
          );
